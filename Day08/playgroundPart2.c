...
int main(int argc, char *argv[])
{
	...
	while(true)
	{
		...
		{
			//connected already?
			//with this uncommented you get a much better
			//solution to the elves problem
...
//				}
		...
		lastIndex	=shortIdx;
		lastIndex2	=sNearestIdx[shortIdx];

		sConnect(&pJunxBoxen[lastIndex], &pJunxBoxen[lastIndex2]);
